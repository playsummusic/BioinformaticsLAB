...
```{r, eval=FALSE, fig.cap=ColabFold structural predictions for two sequences from accession number: XP_001703004.1. Structures are aligned and all cysteine residues are shown in}
