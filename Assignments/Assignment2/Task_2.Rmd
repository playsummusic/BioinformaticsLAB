...
Since we use the newest version of Python (3.14), which is not compatible with ColabFold's newest version, one may install a python version of up to 3.10 and run everything again and get the pdb files. Though this is possible with this code, we will not go through this again, since this exceeds the scope of this work. 
