...
for (pkg in packages) {
  if (!requireNamespace(pkg, quietly = TRUE)) {
    if (pkg %in% c("TreeSummarizedExperiment", 
                   "scater", "mia", "miaViz", "miaQIIME2", "devtools", "rentrez")) {
...
```{r, echo=FALSE, out.width="85%", fig.cap=' Predicted structures of Seq01 and Seq02 aligned. All cysteine residues are displayed as cyanic spheres '}
