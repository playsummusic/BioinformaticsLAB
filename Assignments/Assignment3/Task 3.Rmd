...
```{r, fig.cap="Vulcano plot", fig.height=7, out.width="75%", fig.align="center"}
...
```{r, fig.cap="Enrichment plot with visual clustering for easier analyis. Used categories: 30", fig.align='center', fig.height=4}
