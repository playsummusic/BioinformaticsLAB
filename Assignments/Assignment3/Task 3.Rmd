...
```{r, eval=FALSE}
# if you work on your own PC install the packages first
...
#Read in the results from yesterday
...
**Answer:** The different keytypes and identifiers are:
```{r}
...
```{r}
#View first couple of keys for type GENENAME
keys <-  keys(org.EcK12.eg.db, keytype = "GENENAME")
head(keys,10)
...
##################################
#Try out other keytypes until you find one that contains "almost" all genes
keys <- keys(org.EcK12.eg.db, keytype = "GENENAME")
head(keys)
